...
const String commonHint = 'اذهب للمكان المخصص للعبة للتسليم ';
  List<Question> questions = [
    Question(question: 'دوش 2 - دوش - سه - دوش شيش -درجي', answer: 'مستعد',hint:'شيش جهار يا تيتا'),
    Question(question: 'الف اغنية كشفية مع طليعتك', answer: 'اغنية كشفية',hint:commonHint),
    Question(question: 'ما هي الدولة التي تم بها اخر مؤتمر كشفي عالمي', answer: 'مصر'),
    Question(question: 'لعبة رمي الجولة', answer: 'رمي الجولة',hint:commonHint),
    Question(question: 'متي تأسست الحركة الكشفية في مصر', answer: '1914',hint: 'اذكر السنة فقط'),
    Question(question: 'عمل ( 15 ضغط فردي + 30 بطن فردي + عربية فول في دقيقة للطليعة)', answer: 'تمارين',hint:commonHint),
    Question(question: 'من هي مؤسسة المرشدات ', answer: 'اغنيس بادن باول',hint: 'الاسم ثلاثي'),
    Question(question: 'كيم تذوق ', answer: 'تذوق',hint:commonHint),
    ...
    Question(question: ' لما قالت الفنانة ام كلثوم : الليل وسماه ونجومه وقمره قمره وسهره ....ولا لما قالت برضو حاسين اننا بنحب وبس نحب وبس   .... يا سلام انا جايلك من الكشافة ياست ', answer: 'دن',hint:'استعد عشان الدقيقة بتفرق هنا'),
    ...
    Question(question: 'كيم نظر', answer: 'نظر',hint:commonHint),
    Question(question: ' 11/72/61/72/77/63/22 # 11/72/11/65/55/72  ', answer: 'الطليعة الافضل',hint:'هل تعلم ان هرم خوفو الاثر \nالوحيد المتبقي من عجائب الدنيا السبع '),
    Question(question: 'رسم التسلسل الكشفي لحركة كشافة ومرشدات وادي النيل', answer: 'مصر',hint:commonHint),
    Question(question: 'ماهي اسم الزهرة المستخدمة في علم وعد الفتيان ', answer: 'الزنبق',hint: 'اسم الزهرة فقط '),
    Question(question: 'عمل رسالة بالسيمافور', answer: 'رسالة بالسيمافور',hint:commonHint),
    Question(question: 'في مسابقة رياضية، يتنافس 10 لاعبين. كل لاعب يلعب مع كل لاعب آخر مرة واحدة. كم عدد المباريات التي ستُجرى في هذه المسابقة؟', answer: '45'),
